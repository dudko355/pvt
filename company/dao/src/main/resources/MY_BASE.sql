...
START TRANSACTION;
USE `company`;
INSERT INTO `company`.`CAR` (`idCar`, `condition`, `mark`, `volume`, `mass`, `seatCount`) VALUES (1, 0, 'Volvo', 5,  5, 2);
INSERT INTO `company`.`CAR` (`idCar`, `condition`, `mark`, `volume`, `mass`, `seatCount`) VALUES (2, 0, 'Maz', 10, 10, 4);
INSERT INTO `company`.`CAR` (`idCar`, `condition`, `mark`, `volume`, `mass`, `seatCount`) VALUES (3, 0, 'Mercedes', 15, 15, 6);
INSERT INTO `company`.`CAR` (`idCar`, `condition`, `mark`, `volume`, `mass`, `seatCount`) VALUES (4, 0, 'Renaught', 20, 20, 2);
INSERT INTO `company`.`CAR` (`idCar`, `condition`, `mark`, `volume`, `mass`, `seatCount`) VALUES (5, 0, 'Maz', 25, 25, 4);
INSERT INTO `company`.`CAR` (`idCar`, `condition`, `mark`, `volume`, `mass`, `seatCount`) VALUES (6, 0, 'Maz', 30, 30, 6);
INSERT INTO `company`.`CAR` (`idCar`, `condition`, `mark`, `volume`, `mass`, `seatCount`) VALUES (7, 0, 'Maz', 35, 35, 2);
INSERT INTO `company`.`CAR` (`idCar`, `condition`, `mark`, `volume`, `mass`, `seatCount`) VALUES (8, 0, 'Maz', 40, 40, 4);
INSERT INTO `company`.`CAR` (`idCar`, `condition`, `mark`, `volume`, `mass`, `seatCount`) VALUES (9, -1, 'Maz', 45, 45, 6);
INSERT INTO `company`.`CAR` (`idCar`, `condition`, `mark`, `volume`, `mass`, `seatCount`) VALUES (10, 1, 'Volvo', 50, 50, 2);
...
INSERT INTO `company`.`ORDERS` (`idOrder`, `idClient`, `orderTarget`, `distance`, `dateStart`, `dateFinish`, `volume`, `mass`, `seatCount`) VALUES (2, 2, 'Brest', 100, '2016-09-20', '2016-09-25', 2, 2, 2);
INSERT INTO `company`.`ORDERS` (`idOrder`, `idClient`, `orderTarget`, `distance`, `dateStart`, `dateFinish`, `volume`, `mass`, `seatCount`) VALUES (3, 3, 'Berlin', 100, '2016-09-19', '2016-09-26', 2, 3, 1);
...
INSERT INTO `company`.`TRIP` (`idOrder`, `idClient`, `idTrip`, `tripTarget`, `dateStart`, `dateFinish`, `distance`, `idCar`, `conditionTrip`) VALUES (2, 2, 2, 'Brest', '2016-09-20', '2016-09-25', 100, 1, 0);
INSERT INTO `company`.`TRIP` (`idOrder`, `idClient`, `idTrip`, `tripTarget`, `dateStart`, `dateFinish`, `distance`, `idCar`, `conditionTrip`) VALUES (3, 3, 3, 'Berlin', '2016-09-19', '2016-09-26', 100, 2, 0);
