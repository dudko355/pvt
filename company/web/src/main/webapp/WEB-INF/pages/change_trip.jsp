				...
				<tbody>
					<c:forEach var="trip" items="${ALLTRIP}">
						<tr>
							...
							<td>
								<form
									action="${pageContext.servletContext.contextPath}/admin/trip_cond"
									method="post">
									...
									</select> <input type="submit" value="<fmt:message key="apply" />">
									<input type="hidden" name="change_condition"
										value="${trip.idTrip}" />
								</form>
							</td>
